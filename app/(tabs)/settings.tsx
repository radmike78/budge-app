...
export default function SettingsScreen() {
  ...
  return (
    <Screen>
      ...
      <ListItem title={t.importStatement} subtitle={t.importStatementSub} onPress={() => router.push('/import')} />
      <ListItem title={t.debts} subtitle={t.debtsSub} onPress={() => router.push('/debts')} />
