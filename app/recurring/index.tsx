...
export default function RecurringList() {
  ...
  return (
    <Screen>
      <Text variant="muted" style={{ marginTop: spacing.sm }}>Set up once. Each period OnlyBudget logs the entry for you and moves the next date forward. You can edit or remove any logged entry like normal.</Text>
