...
export default function About() {
  return (
    <Screen>
      <Text variant="title" style={{ marginTop: spacing.sm }}>OnlyBudget</Text>
      ...
      <Card>
        <Text variant="muted">Speech is turned into text by your phone's own recognizer. On devices that support on-device recognition, audio never leaves the phone. OnlyBudget only ever sees the final words.</Text>
      </Card>
