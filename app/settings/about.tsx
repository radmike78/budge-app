...
const COMMITMENTS: [string, string][] = [
  ['No bank linking. Ever.', 'Plainly never asks for bank credentials and never will, not as a feature and not as an upsell. You tell it what happened.'],
  ...
  ['No subscriptions or trials.', 'Whatever Plainly costs is disclosed up front and never changes after you buy. Nothing you already entered is ever put behind a paywall.'],
...
export default function About() {
  return (
    <Screen>
      <Text variant="title" style={{ marginTop: spacing.sm }}>Plainly</Text>
      <Text variant="muted" style={{ marginTop: spacing.xs }}>A manual budget you talk to.</Text>
      ...
      <Card>
        <Text variant="muted">Speech is turned into text by your phone's own recognizer. On devices that support on-device recognition, audio never leaves the phone. Plainly only ever sees the final words.</Text>
      </Card>
